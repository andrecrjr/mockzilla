...
> **Get Started**: Learn [how to create your first workflow](/docs/guides/creating-stateful-workflows) or jump straight into the [Authentication Tutorial](/docs/tutorials/stateful-authentication).
