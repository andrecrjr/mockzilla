...
<div className="space-y-6">
  ...
  <div className="flex gap-4">
    ...
    <div>
      ...
      <div className="text-sm text-muted-foreground">Create a new transition:</div>
      <ul className="list-disc ml-6 mt-2 text-sm space-y-1">
        <li><strong>Path</strong>: `/increment`</li>
        <li><strong>Method</strong>: `POST`</li>
        <li><strong>Effect</strong>: `state.set` → `{"count": "(math state.count + 1)"}`</li>
        <li><strong>Response</strong>: `{"new_count": "(state.count)"}`</li>
      </ul>
    </div>
  </div>
</div>
