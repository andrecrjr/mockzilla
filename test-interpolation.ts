...
console.log(
	`✅ Test 1: ${test1Pass ? 'PASS' : 'FAIL'} - Message contains ID\n`,
);
...
const test2Pass =
	parsed2.greeting.includes(parsed2.user.firstName) &&
	parsed2.greeting.includes(parsed2.user.lastName);
console.log(
	`✅ Test 2: ${test2Pass ? 'PASS' : 'FAIL'} - Greeting contains user names\n`,
);
...
const test3Pass =
	parsed3.statusMessage.includes(parsed3.orderId) &&
	parsed3.statusMessage.includes(parsed3.customerId);
console.log(
