      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <TabsContent value="overview" className="space-y-6">
          <Card className="mockzilla-border mockzilla-glow border-2 bg-card/50 backdrop-blur-sm p-6">
            ...
            <p className="text-muted-foreground mb-4">
              Mockzilla supports dynamic responses defined with JSON Schema, powered by <a href="https://github.com/json-schema-faker/json-schema-faker" rel="noopener noreferrer">JSON Schema Faker</a> and <code className="bg-muted px-1 py-0.5 rounded">@faker-js/faker</code>. You can combine standard JSON Schema formats (like <code className="bg-muted px-1 rounded">email</code> or <code className="bg-muted px-1 rounded">uuid</code>) with Faker directives (like <code className="bg-muted px-1 rounded">person.fullName</code> or <code className="bg-muted px-1 rounded">internet.email</code>) for realistic sample data.
            </p>
...
{`{
  ...
  "message": "Your ID is a7c3f821-9b4d-..."
                        ...
                        <p className="text-xs text-primary mt-2">✨ Notice how the message contains the actual generated ID!</p>
                      </div>
                    </div>
                  </Card>
                </AccordionContent>
                  ...
                  <Card className="mockzilla-border mockzilla-glow border-2 bg-card/50 backdrop-blur-sm p-6">
                    <div className="space-y-6">
                      <div>
                        ...
                        <p className="text-muted-foreground mb-3">Use <code className="bg-muted px-2 py-1 rounded">{"{$.fieldName}"}</code> to reference a field at the root level.</p>
...
{`"message": {
  "const": "Hello {$.userName}!"
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground mb-3">Use dot notation to access nested properties.</p>
                        <pre className="bg-muted p-4 rounded-lg text-sm">
{`"greeting": {
  "const": "Hello, {$.user.firstName} {$.user.lastName}!"
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground mb-3">Use bracket notation to access array elements by index.</p>
                        <pre className="bg-muted p-4 rounded-lg text-sm">
{`"featured": {
  "const": "Try our {$.items[0].name}!"
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground mb-3">You can use multiple references in a single string.</p>
                        <pre className="bg-muted p-4 rounded-lg text-sm">
{`"status": {
  "const": "Order {$.orderId} for {$.customerName} is {$.status}"
              ...
              <AccordionItem value="syntax-alternative">
                ...
                <AccordionContent>
                  <Card className="mockzilla-border bg-card/50 backdrop-blur-sm p-6">
                    <p className="text-muted-foreground mb-3">Both single and double braces work identically:</p>
                    <div className="grid md:grid-cols-2 gap-4">
              ...
              <AccordionItem value="syntax-jsonschema-faker">
                ...
                <AccordionContent>
                  <Card className="mockzilla-border mockzilla-glow border-2 bg-card/50 backdrop-blur-sm p-6">
                    <div className="space-y-6">
                      <div>
                        <h3 className="text-lg font-semibold text-foreground mb-2">Basic Faker Fields</h3>
                        <p className="text-muted-foreground mb-3">Define fields with <code className="bg-muted px-1 rounded">faker</code> paths that map to <code className="bg-muted px-1 rounded">@faker-js/faker</code> methods.</p>
                        <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
{`{
  "type": "object",
  "properties": {
  ...
  "required": ["name", "email"]
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-foreground mb-2">Choose Faker Source with oneOf</h3>
                        <p className="text-muted-foreground mb-3">Use <code className="bg-muted px-1 rounded">oneOf</code> to randomly select one of multiple Faker generators.</p>
                        <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
{`{
  "type": "object",
  "properties": {
                ...
                <AccordionItem value="ex-ticket">
                  ...
                  <AccordionContent>
                    <div className="border-l-4 border-primary pl-4">
                      <p className="text-sm text-muted-foreground mb-3">Create a support ticket with consistent ID across multiple fields.</p>
                      <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
{`{
  "type": "object",
  "properties": {
                ...
                <AccordionItem value="ex-user">
                  ...
                  <AccordionContent>
                    <div className="border-l-4 border-accent pl-4">
                      <p className="text-sm text-muted-foreground mb-3">Generate personalized messages using user data.</p>
                      <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
{`{
  "type": "object",
  "properties": {
                ...
                <AccordionItem value="ex-ecommerce">
                  ...
                  <AccordionContent>
                    <div className="border-l-4 border-secondary pl-4">
                      <p className="text-sm text-muted-foreground mb-3">Reference array elements for featured products.</p>
                      <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
{`{
  "type": "object",
  "properties": {
    ...
    "summary": {
      "const": "Featuring {$.products[0].name} at just $\${$.products[0].price}!"
                ...
                <AccordionItem value="ex-media">
                  ...
                  <AccordionContent>
                    <div className="border-l-4 border-primary pl-4">
                      <p className="text-sm text-muted-foreground mb-3">Randomly choose between avatar or generic image URL.</p>
                      <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
{`{
  "type": "object",
  "properties": {
          ...
          <TabsContent value="advanced" className="space-y-6">
            <Accordion type="single" collapsible className="space-y-4">
              <AccordionItem value="adv-echo">
                ...
                <AccordionContent>
                  <Card className="mockzilla-border bg-card/50 backdrop-blur-sm p-6">
                    <p className="text-muted-foreground mb-4">For POST, PUT, and PATCH methods, you can enable "Echo Request Body" to return exactly what was sent in the request.</p>
                    <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-lg">
                      <div className="flex gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">If the request Content-Type is <code>application/json</code>, the body will be parsed and returned as a proper JSON object.</p>
                        </div>
                      </div>
                    </div>
                  </Card>
              ...
              <AccordionItem value="adv-formats">
                ...
                <AccordionContent>
                  <Card className="mockzilla-border mockzilla-glow border-2 bg-card/50 backdrop-blur-sm p-6">
                    <p className="text-muted-foreground mb-4">For advanced use cases, you can use custom format keywords for explicit control over value generation and storage.</p>
                    <div className="space-y-6">
                      <div>
                        <h3 className="text-lg font-semibold text-foreground mb-2"><code className="bg-muted px-2 py-1 rounded text-sm">x-store-as</code></h3>
                        <pre className="bg-muted p-4 rounded-lg text-sm">
{`"userId": {
  "type": "string",
  "format": "x-store-as",
  "x-key": "mainUserId"
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-foreground mb-2"><code className="bg-muted px-2 py-1 rounded text-sm">x-ref</code></h3>
                        <pre className="bg-muted p-4 rounded-lg text-sm">
{`"createdBy": {
  "type": "string",
  "format": "x-ref",
    ...
    "modifiedBy": {
      ...
      "x-key": "mainUserId"
                        ...
                        <div className="mt-3 p-3 bg-primary/5 border border-primary/20 rounded-lg">
                          <p className="text-sm text-foreground"><strong>Result:</strong> All three fields will have the same generated UUID value.</p>
                        </div>
                      </div>
                    </div>
                  </Card>
                      ...
                      <div className="p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Template references are resolved <strong>after</strong> the entire JSON is generated. Make sure referenced fields exist in your schema.</p>
                          </div>
                        </div>
                      </div>
                      <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Field references are case-sensitive. <code className="bg-muted px-1 rounded">{"{$.Id}"}</code> is different from <code className="bg-muted px-1 rounded">{"{$.id}"}</code>.</p>
                          </div>
                        </div>
                      </div>
                      <div className="p-4 bg-purple-500/10 border border-purple-500/30 rounded-lg">
                        <div className="flex gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">Make sure array indices exist. Referencing <code className="bg-muted px-1 rounded">{"{$.items[10]}"}</code> when the array only has 3 items will fail gracefully.</p>
                          </div>
                        </div>
                      </div>
                    </div>
