    ...
    return (
      <Card className="border-border bg-card p-12">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg font-medium text-muted-foreground">No folders created yet</p>
          <p className="mt-1 text-sm text-muted-foreground">Create your first folder to organize your mocks</p>
        </div>
      </Card>
    )
  }
        ...
        return (
          ...
          >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {folderMocks.length} {folderMocks.length === 1 ? "mock" : "mocks"}
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="border-t border-border bg-muted/50 px-6 py-3 flex items-center justify-between">
              ...
              <p className="text-xs text-muted-foreground">Click to open folder</p>
            </div>
          </Card>
        )
      })}
