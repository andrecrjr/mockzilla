  ...
  if (folders.length === 0) {
    return (
      <Card className="border-border bg-card p-6">
        <h2 className="mb-4 text-2xl font-semibold text-card-foreground">Create New Mock</h2>
        <div className="rounded-lg border border-dashed border-border bg-muted/50 p-8 text-center">
          <p className="text-muted-foreground">Please create a folder first before adding mocks</p>
        </div>
      </Card>
    )
  }
