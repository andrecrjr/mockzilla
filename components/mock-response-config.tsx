		...
		<div className="space-y-4">
			...
			>
				<Tabs
					value={activeTab}
					onValueChange={(v) =>
						onActiveTabChange(v as 'manual' | 'schema' | 'advanced')
					}
				>
						...
						<div className="flex items-center space-x-2">
							...
							<div className="flex items-center gap-2">
								<Label
									...
									onClick={() =>
										onUseDynamicResponseChange(!useDynamicResponse)
									}
								>
									Dynamic Response
								</Label>
							...
							<div className="space-y-3">
								{queryParams.length === 0 ? (
									<p className="text-sm text-muted-foreground">
										No query parameters required. Mock will match any request to
										this endpoint.
									</p>
								) : (
									<div className="space-y-2">
										...
										<div className="flex items-start gap-2 rounded-md border border-amber-500/30 bg-amber-500/5 px-3 py-2.5">
											...
											<div className="space-y-1">
												...
												<p className="text-xs text-amber-600/80 dark:text-amber-400/80">
													Your endpoint{' '}
													<code className="font-mono">{endpoint}</code> doesn't
													contain <code className="font-mono">*</code>. Add a{' '}
													<code className="font-mono">*</code> to capture URL
													segments, e.g.,{' '}
													<code className="font-mono">/users/*</code> or{' '}
													<code className="font-mono">/users/*/posts/*</code>.
												</p>
											</div>
										</div>
									)}
