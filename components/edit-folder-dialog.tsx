  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="ghost" size="sm" className="h-9 w-9 p-0" onClick={(e) => e.preventDefault()}>
      ...
      <DialogContent className="mockzilla-border border-2">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Update the folder name. The URL slug will be automatically updated.</DialogDescription>
          </DialogHeader>
