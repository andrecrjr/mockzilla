  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error("Import Error", {
        description:
          error instanceof Error ? error.message : "Failed to import OpenAPI specification",
      });
    } finally {
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Paste your OpenAPI YAML or JSON specification below. We'll automatically create a folder and mocks for each route.{" "}
              <Link href="/docs#openapi-import" className="text-primary hover:underline inline-flex items-center gap-1">
          ...
          <form onSubmit={handleSubmit} className="grid gap-4 py-4">
            <div className="grid gap-2">
              <div className="flex items-center gap-2">
                <Label htmlFor="openapi-spec">OpenAPI Spec (YAML or JSON)</Label>
                <FieldTooltip
